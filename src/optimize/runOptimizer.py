...
def objective(trial, df, strategy):
    ...
    if strategy == "reactive":
        ...
        params = {
            ...
            "max_reduce": trial.suggest_int("max_reduce_h", 1, 5)
        }
...
def run_optimization(model, strategy):
    ...
    path_json=f'results/optimize/{model}/{model}_{strategy}_best_strategy_params.json'
    ...
    path_txt=f'results/optimize/{model}/{model}_{strategy}_optimization_summary.txt'
